...
| [living-doc-generator-mdoc](https://github.com/AbsaOSS/living-doc-generator-mdoc) | Markdown formatted for an MDoc viewer | A dedicated, browsable documentation site with MDoc-specific navigation/structure, generated straight from GitHub issues and labels. | Available. |
...
- **Need something to browse online, structured like a docs site?** → `generator-mdoc`.
