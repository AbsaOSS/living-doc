...
Feature: Login Page — Validate Password Strength
  ...
  # AC:FUNC-001-02 (v1.0.0 - active) is intentionally left UNCOVERED —
  # no scenario carries @AC:FUNC-001-02. Both declared aspects of AC:FUNC-001-01
  # have a scenario, so that AC is fully covered; FUNC-001-02 is the uncovered counterpart.
